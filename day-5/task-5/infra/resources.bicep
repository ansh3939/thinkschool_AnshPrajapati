...
@description('Name of the existing Container Apps environment to deploy into (subscription is already at its regional environment limit)')
...
param existingContainerAppsEnvironmentResourceGroup string = 'thinkschool-rg'
...
// Reuse the existing Container Apps environment (the subscription is already at its
// regional environment limit in Central India, so a new one cannot be created here).
